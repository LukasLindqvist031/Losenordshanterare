...
using Losenordshanterare; //NB: Exchange this for your projects namespace and add a reference to your own project
using System;
using System.IO;
using System.Text;
...
namespace TestProject
{
    ...
    public class IntegrationTests
    {
        ...
        private void run()
        {
            Losenordshanterare.Program.Main(new string[] { });
        }

        private void run(string[] args)
        {
            Losenordshanterare.Program.Main(args);
        }

        private void run(string a1)
        {
            Losenordshanterare.Program.Main(new string[] { a1 });
        }

        private void run(string a1, string a2)
        {
            Losenordshanterare.Program.Main(new string[] { a1, a2 });
        }

        private void run(string a1, string a2, string a3)
        {
            Losenordshanterare.Program.Main(new string[] { a1, a2, a3 });
        }

        private void run(string a1, string a2, string a3, string a4)
        {
            Losenordshanterare.Program.Main(new string[] { a1, a2, a3, a4 });
        }
        private void run(string a1, string a2, string a3, string a4, string a5)
        {
            Losenordshanterare.Program.Main(new string[] { a1, a2, a3, a4, a5 });
        }
